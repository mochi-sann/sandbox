...
const sdpCreateOfferButton = document.getElementById(
  "sdp-create-offer-button",
) as HTMLButtonElement;
const sdpReceiveButton = document.getElementById(
  "sdp-receive-button",
) as HTMLButtonElement;
...
const iceReceiveButton = document.getElementById(
  "ice-receive-button",
) as HTMLButtonElement;
...
myMediaStream
  .getTracks()
  .forEach((track) => peer.addTrack(track, myMediaStream));

...
export function diff(oldVNode: VNode | string, newVNode: VNode | string): boolean {
...
export function patch(container: Element, oldVNode: VNode | string, newVNode: VNode | string): void {

...
class Main:
    _hx_class_name = "Main"
    __slots__ = ()
    _hx_statics = ["board", "currentPlayer", "main", "play", "getMove", "makeMove", "printBoard", "checkWin", "checkDraw"]
    board = None
    currentPlayer = None
    ...
    def play():
        while True:
            ...
            Main.printBoard()
            if Main.checkWin():
                print(str((("Player " + Std.string(Main.currentPlayer)) + " wins!")))
                break
            elif Main.checkDraw():
                print("Draw game!")
                break
            Main.currentPlayer = (2 if ((Main.currentPlayer == 1)) else 1)

    @staticmethod
    def getMove():
        move = -1
        while (move == -1):
            print(str((("Player " + Std.string(Main.currentPlayer)) + ", enter your move (0-8): ")))
            input = Sys.stdin().readLine()
            move = Std.parseInt(input)
            if ((((move is None) or ((move < 0))) or ((move > 8))) or ((Main.board[move] != 0))):
    ...
    @staticmethod
    def makeMove(move):
        val = Main.currentPlayer
        Main.board[move] = val

    @staticmethod
    def printBoard():
        print(str(((((("\n" + Std.string(Main.board[0])) + " | ") + Std.string(Main.board[1])) + " | ") + Std.string(Main.board[2]))))
        print("-----------")
        print(str(((((Std.string(Main.board[3]) + " | ") + Std.string(Main.board[4])) + " | ") + Std.string(Main.board[5]))))
        print("-----------")
        print(str((((((Std.string(Main.board[6]) + " | ") + Std.string(Main.board[7])) + " | ") + Std.string(Main.board[8])) + "\n")))

    @staticmethod
    def checkWin():
        if (((Main.board[0] != 0) and ((Main.board[0] == Main.board[1]))) and ((Main.board[1] == Main.board[2]))):
            return True
        if (((Main.board[0] != 0) and ((Main.board[0] == Main.board[3]))) and ((Main.board[3] == Main.board[6]))):
            return True
        if (((Main.board[3] != 0) and ((Main.board[3] == Main.board[4]))) and ((Main.board[4] == Main.board[5]))):
            return True
        if (((Main.board[1] != 0) and ((Main.board[1] == Main.board[4]))) and ((Main.board[4] == Main.board[7]))):
            return True
        if (((Main.board[6] != 0) and ((Main.board[6] == Main.board[7]))) and ((Main.board[7] == Main.board[8]))):
            return True
        if (((Main.board[2] != 0) and ((Main.board[2] == Main.board[5]))) and ((Main.board[5] == Main.board[8]))):
            return True
        if (((Main.board[0] != 0) and ((Main.board[0] == Main.board[4]))) and ((Main.board[4] == Main.board[8]))):
            return True
        if (((Main.board[2] != 0) and ((Main.board[2] == Main.board[4]))) and ((Main.board[4] == Main.board[6]))):
            return True
        return False
